-- O cliente precisa saber qual dia (1-7) acabou de ser resgatado pra marcar a
-- caixinha certa na UI, então o retorno passa a ser jsonb com profile + dia + recompensa.
-- Precisa dropar antes: Postgres não permite CREATE OR REPLACE mudar o tipo de retorno.
drop function public.claim_daily_checkin();
